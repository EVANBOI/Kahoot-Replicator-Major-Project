import { clear, adminQuizTrashEmpty, adminAuthRegister, adminQuizRemove, adminQuizCreate, adminQuizTrashView } from '../wrappers';
import { 
    ERROR400, ERROR403, ERROR401, VALID_USER_REGISTER_INPUTS_1, VALID_USER_REGISTER_INPUTS_2, 
    VALID_QUIZ_CREATE_INPUTS_1, INVALID_STRINGIFIED_ARRAY_1, INVALID_STRINGIFIED_ARRAY_2, QUIZ_TRASH_EMPTYED_SUCCESSFUL,
...
describe('error tests', () => {
    ...
    describe('ERROR-401', () => {
        test('Token is empty or invalid, with invalid quizIds', () => {
            ...
            expect(adminQuizTrashEmpty(INVALID_TOKEN, INVALID_STRINGIFIED_ARRAY_2)).toStrictEqual(ERROR401);
        });
    ...
    describe('ERROR-403', () => {
        ...
        test('Token valid but some of the quiz does not exsit', () => {
            expect(adminQuizTrashEmpty(VALID_TOKEN, INVALID_STRINGIFIED_ARRAY_2)).toStrictEqual(ERROR403);
        });
